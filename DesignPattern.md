...
![简单工厂UML示意图](/res/DesignPattern_res/SimpleFactory.png)
```java
...
![策略模式基本结构](/res/DesignPattern_res/1.png)
...
![装饰模式结构图](/res/DesignPattern_res/2.png)
...
![代理模式结构图](/res/DesignPattern_res/3.png)
1. 应用场景：
...
![工厂方法模式](/res/DesignPattern_res/4.png)
...
![原型模式结构图](/res/DesignPattern_res/5.png)
...
![模板方法模式](/res/DesignPattern_res/6.png)
...
![外观模式结构图](/res/DesignPattern_res/7.png)
&#8195;&#8195;使用时机：
...
![建造者模式结构图](/res/DesignPattern_res/8.png)
...
![观察者模式结构图](/res/DesignPattern_res/9.png)
...
![抽象工厂模式](/res/DesignPattern_res/10.png)
...
![状态模式结构图](/res/DesignPattern_res/11.png)
...
![适配器模式](/res/DesignPattern_res/12.png)
...
![备忘录模式结构图](/res/DesignPattern_res/13.png)
...
![组合模式结构图](/res/DesignPattern_res/14.png)
...
![迭代器模式结构图](/res/DesignPattern_res/15.png)
...
![单例模式结构图](/res/DesignPattern_res/16.png)
...
![桥接模式结构图](/res/DesignPattern_res/17.png)
...
![命令模式结构图](/res/DesignPattern_res/18.png)
...
![职责链模式结构图](/res/DesignPattern_res/19.png)
...
![中介者模式结构图](/res/DesignPattern_res/20.png)
...
![享元模式结构图](/res/DesignPattern_res/21.png)
...
![解释器模式结构图](/res/DesignPattern_res/22.png)
...
![访问者模式结构图](/res/DesignPattern_res/23.png)
